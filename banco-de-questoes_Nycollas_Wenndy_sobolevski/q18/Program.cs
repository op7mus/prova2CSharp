...
universe.Add(new Mon2(385));
universe.Add(new Fog());
universe.Add(new Sat());
...
public class Mon2 : Body
{
    public Mon2(float ang)
    {
        Position = new PointF(0f, ang); // distância Terra-Lua
...
public class Fog : Body
{
    public Fog()
    {
        Position = new PointF(100f, 0); // distância Terra-Lua
        
        VelocityX = 0.002f; // 1 km/s
        VelocityY = 0.0025f;
        Color = Color.White;
        Mass = 5.00f;
        Size = 3.4748f; // 3474,8 km
...
public class Sat : Body
{
    public Sat()
    {
        Position = new PointF(0f, 100); // distância Terra-Lua
        
        VelocityX = (6.67f*5.97f/20000f); // 1 km/s
        VelocityY = 0;
        Color = Color.White;
        Mass = 5.00f;
        Size = 3.4748f; // 3474,8 km
